...
echo "  - Run 2 should NOT show any 'Prefilling' logs (prefill skipped)"
echo "  - If prefill skipped in Run 2, KV cache recovery is working"
echo ""
echo "Known issue: Generated tokens from Run 1 are not continued in Run 2"
echo "=== Done ==="
